...
\end{figure}
\footnotetext{Desde el canal de YouTube de Carlos Santana \url{https://www.youtube.com/watch?v=MRIv2IwFTPg} \label{CarlosSantana}}
...
\begin{figure}[h]
	...
	\caption[AND resuelta por un solo perceptrón.]{AND resuelta por un solo perceptrón\footref{CarlosSantana}.}
\end{figure}
...
\begin{figure}[h]
	...
	\caption[XOR resuelta por dos perceptrones.]{XOR resuelta por dos perceptrones\footref{CarlosSantana}.}
\end{figure}
